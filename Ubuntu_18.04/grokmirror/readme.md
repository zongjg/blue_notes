...
```shell script
# Install prerequests
sudo apt install -y git python-git python-anyjson
...
# to use Beijing: `site = https://beijing.source.codeaurora.org`
site = git://source.codeaurora.org
#
...
# to use Beijing: `manifest = https://beijing.source.codeaurora.org/manifest.js.gz`
manifest = https://source.codeaurora.org/manifest.js.gz
#
# Where are we going to put the mirror on our disk?
#toplevel = /var/lib/git/mirror
toplevel = /home/bmx/ws/.mirror/lib/git/mirror
#
# Where do we store our own manifest? Usually in the toplevel.
#mymanifest = /var/lib/git/mirror/manifest.js.gz
mymanifest = /home/bmx/ws/.mirror/lib/git/mirror/manifest.js.gz
#
...
projectslist = /home/bmx/ws/.mirror/lib/git/mirror/projects.list
#
...
log = /home/bmx/ws/.mirror/log/mirror/codeaurora.org.log
#
...
````shell script
# Install prerequests
sudo apt install -y libfcgi-dev autoconf libtool automake pkg-config fcgiwrap spawn-fcgi nginx-fullf
````